...
class MinMaxStack {
  ...
  push(val) {
    ...
    if (!this.top) {
      this.top = newNode;
      this.top.max = this.top.min = this.top;
      this.bottom = this.top;
    } else {
      const temp = this.top;
      this.top = newNode;
      this.top.next = temp;
      this.top.max = this.top.max.value > temp.value ? this.top.max : temp;
      this.top.min = this.top.min.value < temp.value ? this.top.min : temp;
    }
    return ++this.length;
  }
